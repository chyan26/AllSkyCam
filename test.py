...
# Input data
altitude_deg = 23.29     # Altitude of the Sun in degrees
azimuth_deg = 265.92      # Azimuth (position angle) of the Sun in degrees, 0 = North, 90 = East
local_time = datetime(2024, 9, 6, 16, 19, 27)  # Local time of observation (example date and time)

def compute_sun_alt_az(latitude, longitude, timezone_offset):
...
def objective(coords):
    ...
    computed_alt, computed_az = compute_sun_alt_az(latitude, longitude, 8)
